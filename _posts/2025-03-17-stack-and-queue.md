...
title: 'StackAndQueue'
date: 2025-03-17
permalink: /posts/2025/03/2025-03-17-stack-and-queue/
tags:
  - 数据结构与算法
categories:
  - 数据结构与算法
...
>
> ![alt text](/images/stack-and-queue/访问受限的线性表.png)
...
### 顺序栈——栈的顺序存储实现
**顺序栈存储空间的处理**
![alt text](/images/stack-and-queue/顺序栈存储空间的处理.png)
...
### 栈的应用
* **十进制数到二进制数的转换**
![alt text](/images/stack-and-queue/十进制转二进制.png)
<br>
...
* **算术表达式求值的栈实现**
    ...
    * 扫描到')'，OP出栈，到pop出')'为止。如果pop出的元素不是'('或')'，则将元素压入R
    ![alt text](/images/stack-and-queue/后缀表达式.png)

### 递归
> **适用情况：问题可以<mark>收敛</mark>**

* **阶乘求值**
![alt text](/images/stack-and-queue/阶乘求值.png)
<br>
<br>
...
定义如下：
![alt text](/images/stack-and-queue/阿克曼函数定义.png)
    递归实现：
    ```cpp
    #include<bits/stdc++.h>
    using namespace std;
...
* **斐波那契数列**
递归定义：
![alt text](/images/stack-and-queue/斐波那契定义.png)
<br>

    递归实现：
    ![alt text](/images/stack-and-queue/斐波那契实现.png)
    F(5)的栈调用情况：
    ![alt text](/images/stack-and-queue/斐波那契栈调用.png)
<br>
<br>

* **最大公约数**
定义：可以同时除尽两个正整数的最大的正整数
![alt text](/images/stack-and-queue/最大公约数.png)
<br>
...
示例：
![alt text](/images/stack-and-queue/互递归.png)
<br>
<br>

* **汉诺塔问题**
递归步骤：
![alt text](/images/stack-and-queue/汉诺塔.png)
<br>

    递归实现：
    ![alt text](/images/stack-and-queue/汉诺塔实现.png)
    ***先把 n - 1 个移动到y，然后移动最底下的到z，然后把 n - 1 个从y移动到z***
<br>

    复杂度分析：
    ![alt text](/images/stack-and-queue/汉诺塔复杂度分析.png)
<br>
<br>
...
### 顺序队列
#### 存储
![alt text](/images/stack-and-queue/顺序队列的存储.png)
<br>

#### 操作
![alt text](/images/stack-and-queue/顺序队列的操作.png) 
![alt text](/images/stack-and-queue/顺序队列的操作2.png)
...
<br>
> ![alt text](/images/stack-and-queue/循环队列.png)

<br>

* **方法一：留出空位**
![alt text](/images/stack-and-queue/留出空位.png)
    判断条件：
    1. 队列为空：**front == rear**
...
* **其他方法易于理解**：
![alt text](/images/stack-and-queue/其他方法.png)
<br>
<br>

### 链式队列——链式存储方式
和链表的逻辑一致，易于理解：
![alt text](/images/stack-and-queue/链式队列.png)

### 优先队列
易于理解：
![alt text](/images/stack-and-queue/优先队列.png)

### 队列的应用：杨辉三角
![alt text](/images/stack-and-queue/杨辉三角.png)
<br>
